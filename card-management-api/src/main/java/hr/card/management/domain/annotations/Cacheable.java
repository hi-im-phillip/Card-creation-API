...
import static hr.card.management.domain.aspect.CacheableAspect.DEFAULT_MAX_CACHE_SIZE;
import static hr.card.management.domain.aspect.CacheableAspect.DEFAULT_MAX_HOURS_IN_CACHE;
